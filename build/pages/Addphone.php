...
if(isset($_POST['submit']))
{
  ...
  $sql = "UPDATE addressbook SET addmobile='$a',addland = '$b' WHERE lname='$type'";
  ?>
 <p style="color: gold;"><?php echo("Successfully Added"); ?> </p><?php
...
<div class="wrapper row4">
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li class="active"><a href="Addphone.php">Add Telephone</a></li>
...
<div style="background-image:url('../images/demo/backgrounds/05.png');">
  <section id="breadcrumb" class="hoc clear"> 
    ...
    <!-- ################################################################################################ -->
    <h6 class="heading">Add Telephone</h6>
    <!-- ################################################################################################ -->
  </section>
</div>
<!-- ################################################################################################ -->
...
$done = mysqli_query($link, $sql);
      ...
      <tr>
        <td> <label for="email">Additonal Mobile Number <span>*</span></label></td>
        <td><input type="Telephone" name="phone" id="phone" value="" size="22" required></td>
      </tr>
      <tr>
        <td> <label for="email">Additonal Land Number <span>*</span></label></td>
        <td><input type="Telephone" name="lphone" id="lphone" value="" size="22" required></td>
      </tr>
      <tr>
