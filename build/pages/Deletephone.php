...
if(isset($_POST['submit']))
{
  ...
  $sql =  "UPDATE addressbook SET $type1=null WHERE lname = '$type'";
 ?>
 <p style="color: gold;"><?php echo("Successfully Deleted"); ?> </p><?php
    ...
    <ul class="clear">
      ...
      <li ><a href="Addphone.php">Add Telephone</a></li>
       <li ><a href="Deleteentry.php">Delete Entry</a></li>
        <li class="active"> <a href="Deletephone">Delete Phone</a></li>
...
<div style="background-image:url('../images/demo/backgrounds/05.png');">
  <section id="breadcrumb" class="hoc clear"> 
    ...
    <!-- ################################################################################################ -->
    <h6 class="heading">Delete Phone</h6>
    <!-- ################################################################################################ -->
  </section>
</div>
<!-- ################################################################################################ -->
...
$done = mysqli_query($link, $sql);
       ...
       <tr>
        ...
        <td><input type="text" name="mn" id="mn" value="" size="22" required></td>
      </tr>
      <tr>
        <td>Type<span>*</span></td>
        <td><select name="type1">
  <option value="mobilenumber" id="mobile">Mobile Number</option>
  <option value="landnumber" id="land">Land Number</option>
  <option value="addmobile" id="amn">Additional Mobile Number</option>
   <option value="addland" id="aln">Additional Land Number</option>
 
</select></td>
      </tr>
    
      <tr>
        <td><input type="submit" name="submit" value="Delete" onclick="return confirm('Are you sure you want to delete this item?');"></td>
